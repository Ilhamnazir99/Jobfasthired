    ...
    <div class="relative px-6 py-16 bg-cover bg-center bg-no-repeat"
        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center text-white">
            ...
            <div>
                ...
                <!-- Search Form -->
                <div class="flex flex-col-reverse md:flex-row items-start md:items-center justify-between gap-6">
                    {{-- Search Form --}}
                    <form id="job-search-form" action="{{ route('job.search') }}" method="GET"
                        ...
                        <div class="flex flex-wrap gap-4">
                            ...
                            <input type="text" name="title" placeholder="Job title..." value="{{ request('title') }}"
                                class="flex-1 min-w-[150px] p-3 border rounded-md shadow-sm focus:ring focus:ring-blue-200 text-black">
                            ...
                            <!-- <div class="relative flex-1 min-w-[150px]">
                                ...
                                <button type="button" id="use-location-btn" x-data="{ show: false, timeout: null }"
                                    ...
                                    <svg data-lucide="map-pin"
                                        class="w-5 h-5 stroke-blue-500 transition-colors duration-200"></svg>
